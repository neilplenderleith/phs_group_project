...
scotland <- st_read("../../../../Downloads/SG_NHS_HealthBoards_2019/SG_NHS_HealthBoards_2019.shp")
...
ggplot(data = scotland) +
geom_sf(fill = "grey")+
geom_text(aes(x = lat , y = long, label = HBNumber), color = "darkblue", fontface = "bold", check_overlap = TRUE) 
```
